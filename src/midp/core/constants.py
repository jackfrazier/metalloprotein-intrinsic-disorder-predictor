...
COORDINATION_GEOMETRIES: Dict[str, Dict[str, any]] = {
    "linear": {"coordination_number": 2, "angles": [(180.0,)], "tolerance": 10.0},
    "trigonal_planar": {
...
METAL_LIGAND_DISTANCES: Dict[str, Dict[str, Tuple[float, float]]] = {
    ...
    "FE": {"N": (1.9, 2.3), "O": (1.8, 2.2), "S": (2.2, 2.6)},
    "ZN": {"N": (1.9, 2.2), "O": (1.9, 2.2), "S": (2.2, 2.5)},
    "CU": {"N": (1.9, 2.3), "O": (1.9, 2.3), "S": (2.2, 2.6)},
    "CA": {"O": (2.2, 2.6), "N": (2.3, 2.7)},
    "MG": {"O": (2.0, 2.3), "N": (2.1, 2.4)},
}
